...
export async function getUtxoBalanceForAddressList(inputs: any, outputs: any, addressList: any) {
...
export function getUtxoBalanceForAddressList2(inputs: any, outputs: any, addressList: any) {
