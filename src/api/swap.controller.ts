...
const swapOwlUrl = '/api/v1/swap/owl'
...
export default class SwapController {
  ...
  static async SwapSigUSD(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      profiler.done({
        message: 'validating SwapSigUSD request params failed',
        level: 'error',
        session_id: uuid,
    ...
    profiler.done({
      message: 'SwapSigUSD build tx successful',
      session_id: uuid,
      tx_id: `${txId}`,
      code: 200,
      url: swapSigUrl,
  ...
  static async SwapOWL(req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      profiler.done({
        message: 'validating SwapOWL request params failed',
        level: 'error',
        session_id: uuid,
        error: getErrorMessage(e),
        code: 400,
    ...
    profiler.done({
      message: 'SwapOWL build tx successful',
      session_id: uuid,
      tx_id: `${txId}`,
      code: 200,
      url: swapOwlUrl,
